...
public class Simulation 
{
	...
	private ArrayList<SocialNPC> snpcs;
	private Random rand;
	...
	public Simulation(int numSNPCs, int numTurns, int numRepeats, int cohesion, boolean holes, double questSuccessRate, int expNum)
	{
		...
		thePlayer = new Player(0, "Playerrr", "The player.", 50);
		snpcs = new ArrayList<SocialNPC>();
		rand = new Random();
	...
	private void setUp(int simNumber)
	{
		...
		for(int i = 0; i < population; i++)
		{
			...
			currentSNPC = new SocialNPC(id, name, desc, life, damage, armor, speed, pers);
