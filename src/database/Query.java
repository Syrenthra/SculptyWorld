 ...
 */
    ...
    protected SecureServerConnection m_serverConnection;
 ...
 * @see SWServer.ship.wl.io.MKServer#m_dbConnections
 */
    public Query (String name, SecureServerConnection sc)
        {
        m_queryDB = name;
        m_serverConnection = sc;
        }
 ...
 */
    public void closeConnection()
        {
        try  { m_databaseConnection.close(); }
        catch( Exception e ) 
            {
            m_serverConnection.addToLog(e.getMessage());
            }
        }
 ...
 */
    ...
    public void setServerConnection(SecureServerConnection sc)
        {
        m_serverConnection = sc;
        }
